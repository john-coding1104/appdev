...
import { RootStackParamList, RootState, Package } from '../types';

type BookPackageScreenNavigationProp = StackNavigationProp<RootStackParamList, 'BookPackage'>;
type BookPackageScreenRouteProp = RouteProp<RootStackParamList, 'BookPackage'>;

const BookPackageScreen: React.FC = () => {
  const navigation = useNavigation<BookPackageScreenNavigationProp>();
  const route = useRoute<BookPackageScreenRouteProp>();
